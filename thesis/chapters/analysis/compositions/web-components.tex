...
HTML Templates allow for the definition of markup templates that can be reused and instantiated multiple times within a document. These templates are not rendered until they are explicitly activated. \cite{MicrofrontendsInAction}\cite{BuildingMicrofrontends}\\

...
\paragraph*{Kľúčové slová:} Microfrontends, Web-components, architektúry webových aplikácií, Angular, projektový manažment
...
\paragraph*{Keywords:} Microfrontends, Web-components, web application architectures, Angular, project management
